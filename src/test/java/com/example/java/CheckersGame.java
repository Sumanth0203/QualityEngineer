...
public class CheckersGame {
    ...
    By BluePieces = By.xpath("//img[contains(@src,'blue.gif')]");

    By Restart = By.xpath("//a[text()='Restart...']");

    By MakeAMove = By.xpath("//p[text()='Make a move.']");

    public CheckersGame(WebDriver driver){
        this.driver = driver;
    }
    ...
    public void makeMoves(int count) throws InterruptedException {
        ...
        for (WebElement line : lines){
            ...
            if(!orangePieces.isEmpty()){
                for(WebElement op: orangePieces){
                    ...
                    WebElement bluePiece = null;
                    if(d1 !=null && d1.getAttribute("src").contains("blue.gif")){
                        bluePiece=d1;
                    }

                    if(bluePiece == null && d2 !=null && d2.getAttribute("src").contains("blue.gif")){
                        bluePiece=d2;
                    }
